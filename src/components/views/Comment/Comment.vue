...
<template>
  <div class="container">
    ...
    <div class="comment" v-for="item in comments">
      <div class="info">
        <img :src="item.fromAvatar" class="avatar" height="36" width="36" />
        <div class="right">
      ...
      <div class="control">
        <span :class="{active: item.isLike}" @click="likeClick(item)" class="like">
          <i class="iconfont icon-like"></i>
          <span class="like-num">{{item.likeNum > 0 ? item.likeNum + '人赞' : '赞'}}</span>
        </span>
        <span @click="showCommentInput(item)" class="comment-reply">
        ...
        <transition name="fade">
          <div class="input-wrapper" v-if="showSecondReplyId === item.id">
            ...
            <div class="btn-control">
              ...
              <el-button @click="commitComment" class="btn" round type="success">确定</el-button>
            </div>
          </div>
        </transition>
      </div>
      ...
      <div class="reply">
        <div class="item" v-for="reply in item.reply">
          ...
          <div class="reply-bottom">
            ...
            <span @click="showCommentInput(item, reply)" class="reply-text">
              <i class="iconfont icon-comment"></i>
              <span>回复</span>
            </span>
          </div>
      ...
      if (this.inputComment) {
        ...
        this.$http({
          ...
          data: this.$http.adornData({
            ...
            content: "15632065103212e1 faewds"
          })
        }).then(({ data }) => {
          console.log(data);
        ...
        this.comments.unshift({
          ...
          fromId: localStorage.getItem("blog_username"),
          fromName: localStorage.getItem("blog_username"),
          fromAvatar:
